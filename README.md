...
a network lookup). Full behavior, precedence against workspace members, and the
index hardening rules are in [local-registry.md](docs/local-registry.md).
