...
| `zed inspect --format json [--root PATH]` | Emit the versioned, non-mutating editor protocol for package state, Git-submodule opt-in, mise locks, and `nix develop` inputs without executing those tools |
